...
const MyAppointments = () => {
  ...
  return (
    <div className='py-6'>
      <h1 className='text-2xl sm:text-3xl font-semibold text-gray-800 mb-5'>My Appointments</h1>
      ...
      {myAppointments.length === 0 ? (
        ...
        <div className='space-y-3'>
          {myAppointments.map((item) => (
            <div key={item.id} className='border border-gray-200 rounded-2xl p-5 bg-white'>
